...
public class SearchBar : MonoBehaviour
{
   ...
   protected List<string> names = new List<string>() {"Sort By ", "Distance", "Alphabetical" };
...
//added stuff starting here (stuff for dropdown menu for search page)
/*
public class Dropdown_SortBy : SearchBar
{

    List<string> names = new List<string>() { "Sort By", "Distance", "Alphabetical" };
