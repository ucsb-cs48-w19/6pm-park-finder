...
/Applications/Unity/Unity.app/Contents/MacOS/Unity -batchmode -logFile $(pwd)/unity.log -nographics -silent-crashes -projectPath "/Users/travis/build/ucsb-cs48-w19/6pm-park-finder/${project}" -executeMethod Build.PerformBuild \ -quit
