...
/Applications/Unity/Unity.app/Contents/MacOS/Unity -batchmode -silent-crashes -logFile $(pwd)/unity.log -projectPath "/Users/travis/build/ucsb-cs48-w19/6pm-park-finder/6pm-park-finder" -executeMethod Build.PerformBuild -quit
cat $(pwd)/unity.log
